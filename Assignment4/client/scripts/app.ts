...
(function(){
    ...
    /**
     * Applies functionality for the navbar search and changing the visuals active links
     */
    ...
    /**
     * Sets the 'active' class on the navigation link that matches the current page title.
     */
    ...
    function DisplayLoginPage(): void {
        ...
        let loginForm = $("#loginForm") as JQuery<HTMLFormElement>;

        // Form Submit Event
        loginForm.on("submit", function (event): void {
            event.preventDefault();
    ...
    function DisplayRegisterPage(): void {
        ...
        let registerForm = $("#registerForm") as JQuery<HTMLFormElement>

        RegisterFormValidation();

        registerForm.on("submit", function (event): void {
            event.preventDefault();
