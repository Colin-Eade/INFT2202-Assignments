...
(function(){
    ...
    function LoadHeader(): void {
        $.get("./includes/header.html", (data): void => {
            let noPrefixTitle: string =  document.title.replace(titlePrefix, "");
            $("header").html(data);
            ChangeNavBar();
            NavBarSearch();
     ...
     */
    function LoaderFooter(): void {
        $.get("./includes/footer.html", (data): void => {
            $("footer").html(data);
        });
    }
